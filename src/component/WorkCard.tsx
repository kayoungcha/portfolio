    ...
    <>
      ...
      >
        ...
        >
          ...
          <WorkTitle title={item.name} moreStyles="mb-[12px]"></WorkTitle>
        ...
        <article className="relative h-full">
          ...
          >
            ...
            >
              ...
              {alertShow && loaded && (
                <div
                  className={`alert absolute left-0 bg-black/50
                  backdrop-blur-[10px] text-white rounded-2xl py-[40px]
                ...
                >
                  ...
                  >
                    ...
                    다릅니다. 웹에서 작동하게 만든 사이트로 실제 어플 구동과는
                    차이가 있을 수 있습니다. <br />
                    <br /> 이미지 업로드 서비스는 어플 용 플러그인으로 <br />
                    카피 페이지에서는 실행 되지않습니다.
                  </p>
                </div>
              )}
            ...
            >
              <WorkTypeChip type={item.type} moreStyles="mb-[14px] ml-[-2px]" />
              <div
                className="title_wrap flex items-end justify-between mb-[4px]"
              >
                <WorkTitle title={item.name} />
                <span
              ...
              <div
                className="tools_wrap w-full flex gap-x-[16px] justify-between
                  mb-[24px]"
              >
                <section className="dev_tools">
                  <ModalSubTitle title={'개발 도구'}></ModalSubTitle>
                  <div className="flex flex-wrap gap-[8px] mb-[8px]">
                    {item.skill.map((ele) => {
                      return (
                        <WorkTagChip
                          key={item.name + 'detail' + ele}
                          type={'skill'}
                          text={ele}
                        />
                      );
                ...
                <section className="flex flex-col w-fit">
                  <ModalSubTitle title={'배포 플랫폼'}></ModalSubTitle>
                  <div
                    className="app_icon_area flex gap-x-[16px] items-end"
                    title="배포 플랫폼"
                  >
                    <div
                      className="icon_android w-[32px] h-[32px] object-contain
                        relative"
                    >
                      <svg
                        viewBox="0 0 152 89"
                    ...
                    <div
                      className="icon_ios w-[32px] h-[32px] object-contain
                        relative"
                    >
                      <svg
                        viewBox="0 0 50 50"
              ...
              <section className="flex gap-x-[16px] mb-[24px] justify-between">
                <div>
                  <ModalSubTitle title={'참여 범위'}></ModalSubTitle>
                  <p className="font-light text-[1.4rem] text-txt-tertiary">
                    퍼블리싱, 채팅페이지 제외 모든페이지 개발
                  </p>
                </div>
                <div>
                  <ModalSubTitle title={'작업 기간'}></ModalSubTitle>
                  <p className="font-light text-[1.4rem] text-txt-tertiary">
                    1.5개월
                  </p>
                </div>
              ...
              <section className="key_features mb-[24px]">
                <ModalSubTitle title={'주요 기능'}></ModalSubTitle>
                <ul className="">
              ...
              <section>
                <ModalSubTitle title={'주요 성과 및 도전과제 '}></ModalSubTitle>
              </section>
            </div>
          </div>
        </article>
